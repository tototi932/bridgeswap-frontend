...
const FaqContainer = styled(Flex)`
    border-radius: 20px;
    background: linear-gradient(248.11deg, rgb(10, 10, 10) 25.22%, rgb(10, 10, 10) 122.1%);
    padding: 20px;
    ...
    return (
        <FaqContainer>
            <Wordings>
                ...
                <DocsLink href='https://doge-gold-floki-finance.gitbook.io/dgf/' target='_blank' rel='noreferrer noopener'>
